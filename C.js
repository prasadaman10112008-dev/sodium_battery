function load_section16(mainContainer) {
  mainContainer.innerHTML = `
    <section id="report-section16">
      ...
      <!-- Chart container with increased size and scroll wrapper for mobile -->
  ...
  if (!document.getElementById('report-section-style')) {
    ...
    style.textContent = `
      ...
      /* Chart container – increased height and scroll support */
      .chart-container {
        position: relative;
        width: 100%;
        max-width: 650px;
        ...
        overflow-x: auto;
        -webkit-overflow-scrolling: touch;
        /* Height will be overridden by inline style, but fallback */
        height: 450px;
      }
