function load_section16(mainContainer) {
  mainContainer.innerHTML = `
    <section id="report-section16">
      ...
      <div class="chart-container">
        <canvas id="conclusionChart" style="display: block; max-width: 100%; height: auto;"></canvas>
  ...
  // Render the chart – fully responsive on all devices
  ...
  // Ensure responsive chart container styles exist
