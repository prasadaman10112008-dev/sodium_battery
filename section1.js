function load_section1(mainContainer) {
  mainContainer.innerHTML = `
    <section id="report-section1">
      ...
      <p>
        The report is divided into seventeen logically sequenced sections:
      </p>
      <div class="report-toc-scroll">
        <table class="report-toc-table">
          ...
          <tbody>
            ...
            <tr><td>16</td><td>National Impact & Energy Independence</td><td>Scenario‑based oil import reduction and Atmanirbhar Bharat</td></tr>
            <tr><td>17</td><td>Conclusion</td><td>Key takeaways, realistic positioning, next steps</td></tr>
          </tbody>
        </table>
      </div>
  ...
  // Inject styles (once) – includes scrollable table of contents for mobile
  if (!document.getElementById('report-section-style')) {
    ...
    style.textContent = `
      ...
      /* Table of contents – scrollable on mobile */
      .report-toc-scroll {
        width: 100%;
        overflow-x: auto;
