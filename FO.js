function load_section15(mainContainer) {
  mainContainer.innerHTML = `
    <section id="report-section15">
      ...
      <div class="chart-container chart-scrollable" style="position: relative; width: 100%; max-width: 650px; margin: 0 auto 30px; background: var(--surface); border: 1px solid var(--border); border-radius: 14px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.03); overflow-x: auto; -webkit-overflow-scrolling: touch;">
      ...
      <div class="table-wrap table-swipe" style="width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch; margin-bottom: 20px; border-radius: 10px; box-shadow: 0 1px 4px rgba(0,0,0,0.03);">
        <table style="min-width: 650px; width: 100%; border-collapse: collapse; background: var(--surface); font-size: 0.82rem;">
          <thead>
  ...
  if (!document.getElementById('report-section-style')) {
    ...
    style.textContent = `
      ...
      /* Chart container – responsive height, scrollable on mobile */
      .chart-container {
        position: relative;
        width: 100%;
        max-width: 650px;
        ...
        height: 450px;                /* Desktop height (50% bigger than original) */
      }
      .chart-scrollable {
        overflow-x: auto;
      ...
      @media (max-width: 600px) {
        .chart-container {
          height: 350px;              /* Optimized for mobile */
          padding: 16px 12px;
        }
      }
