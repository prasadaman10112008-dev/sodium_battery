function load_section15(mainContainer) {
  // Full content of Section 15 – Future Outlook
  mainContainer.innerHTML = `
    <section id="report-section15">
      ...
      <div class="chart-container" style="position: relative; width: 100%; max-width: 650px; margin: 0 auto 30px; background: var(--surface); border: 1px solid var(--border); border-radius: 14px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.03); height: 300px;">
