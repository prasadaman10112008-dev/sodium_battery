function load_section15(mainContainer) {
  mainContainer.innerHTML = `
    <section id="report-section15">
      ...
      <div class="chart-container">
        <canvas id="macroRelevanceChart" style="display: block; max-width: 100%; height: auto;"></canvas>
  ...
  // Render macro relevance horizontal bar chart (fully responsive)
  ...
  // Ensure shared styles exist, with responsive chart container
  if (!document.getElementById('report-section-style')) {
    ...
    style.textContent = `
      ...
      .chart-container {
        ...
        overflow-x: auto;
        height: 300px;  /* give the chart a defined container height */
      }
      .highlight-box {
        background: #fdf8f0;
