function load_uvp(mainContainer) {
  mainContainer.innerHTML = `
    <section id="uvp-section">
      ...
      <!-- REALISTIC RADAR CHART -->
      <div class="uvp-chart-wrapper">
        <canvas id="uvpRadarChart" width="500" height="500"></canvas>
      ...
      <!-- 8 UVP CARDS (Recycling card updated) -->
      <div class="uvp-grid">
        <div class="uvp-card">
    ...
    new Chart(ctx, {
      ...
      options: {
        ...
        plugins: {
          ...
          subtitle: {
            display: true,
            text: 'Scores out of 100. Our Platform: TRL‑2 projections. WeLion: lab‑proven. Realistic competitive landscape.',
