function load_plan(mainContainer) {
  mainContainer.innerHTML = `
    <section id="plan-section">
      ...
      <!-- Main plan table – now scrollable -->
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                • Energy density: <strong>150–250 Wh/kg</strong><br>
                • Cycle life: <strong>≥500 rechargeable cycles</strong><br>
            ...
            <tr>
              ...
              <td>
                ...
                • Cycle life testing<br>
                • Coulombic efficiency and self‑discharge measurement
              </td>
              <td>
                • Stable electrolyte with acceptable room‑temperature conductivity<br>
                • Energy density: <strong>250–350 Wh/kg</strong><br>
                • Cycle life: <strong>≥1,000 rechargeable cycles</strong><br>
            ...
            <tr>
              ...
              <td>
                • Energy density: <strong>350–450 Wh/kg</strong><br>
                • Cycle life: <strong>1,500–3,000 cycles</strong><br>
      ...
      <p style="font-size:0.85rem; color:var(--text-muted); margin-top:16px;">
        <em>Total estimated cost for 18‑month plan: <strong>₹28 – 35 Lakhs</strong>. This covers lab access, materials, small equipment, and a lean team of 2‑3 researchers. All timelines assume continuous lab access and no fundamental technical dead‑ends.</em>
      </p>
