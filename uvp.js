  ...
  mainContainer.innerHTML = `
    <section id="uvp-section">
      ...
      <p class="uvp-intro">
        ...
        All performance figures are <strong>development targets</strong> based on the solid‑state sodium–sulfur chemistry and will be validated through phased prototyping (TRL‑2 → TRL‑5).
      </p>

      <!-- RADAR CHART – correct size, no blur, no stretch -->
      <div class="uvp-chart-wrapper" style="position: relative; width: 100%; max-width: 620px; margin: 0 auto 40px; background: var(--surface); border: 1px solid var(--border); border-radius: 14px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.03); height: 400px; overflow-x: auto; -webkit-overflow-scrolling: touch;">
        <canvas id="uvpRadarChart" style="display: block; width: 100%; height: 100%;"></canvas>
        <p style="text-align:center; font-size:0.75rem; color:var(--text-muted); margin-top:6px;">
          Scores out of 100. Our Platform: TRL‑2 projections. WeLion: demonstrated 824 Wh/kg in lab. All others: commercially available (2024‑2025 data).
        </p>
      </div>

      <!-- 8 UVP CARDS – concise, up‑to‑date targets -->
      <div class="uvp-grid">
        <div class="uvp-card">
          <div class="uvp-icon">01</div>
          <h3>Inherent Fire Safety</h3>
          <p>Solid‑state electrolyte eliminates flammable liquids, targeting <strong>zero thermal runaway risk</strong>. No fire suppression or complex cooling needed — a fundamental upgrade for EVs, data centres, and defence.</p>
        </div>
        <div class="uvp-card">
          <div class="uvp-icon">02</div>
          <h3>Critical Mineral Freedom</h3>
          <p>Uses <strong>only abundant sodium and sulfur</strong> — no lithium, cobalt, or nickel. Insulates customers from geopolitical supply shocks, child labour concerns, and volatile pricing.</p>
        </div>
        <div class="uvp-card">
        ...
        <div class="uvp-card">
          ...
          <p>Na‑S chemistry contains fewer critical elements, which <strong>may simplify separation</strong> compared to multi‑metal NMC. Solid‑state electrolyte recycling is under development. Designed with future circular economy regulations in mind.</p>
        </div>
        <div class="uvp-card">
      ...
      <!-- COMPARISON TABLE – updated with latest data -->
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><strong>Moderate</strong> (simpler chemistry)</td>
              <td>Moderate</td>
              <td>Moderate</td>
              <td>Moderate</td>
              <td>High</td>
              <td>Low (complex sulfide)</td>
            </tr>
            <tr>
      ...
      <p style="font-size:0.8rem; color:var(--text-muted); margin-top:12px;">
        <em>All projected figures are targets. WeLion achieved 824 Wh/kg in lab (sulfide electrolyte, lithium‑metal). Data based on public sources (2024‑2025).</em>
      </p>
    </section>
  `;
  ...
  if (!document.getElementById('uvp-style')) {
    ...
    style.textContent = `
      ...
      @media (max-width: 600px) {
        .uvp-chart-wrapper {
          height: 350px;   /* a bit smaller on phone but still clear */
        }
      }
    `;
