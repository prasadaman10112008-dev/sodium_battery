function load_milestone(container) {
  container.innerHTML = `
    <style>
      ...
      .recent-activity { background: #f0f7ff; border: 1px solid #c8dbef; border-radius: 12px; padding: 16px 20px; margin-bottom: 24px; font-size: 0.9rem; color: #1a3a5c; }
    </style>
    <div class="ms-container">
      <div class="ms-header">
        ...
        <div style="margin-top:14px;">
          <span class="trl-badge trl-current">TRL 2 – Concept & Formulation Complete (100%)</span>
          <span style="margin-left:10px; font-size:0.85rem; color:var(--text-muted);">Next target: TRL 3 (Proof of Concept) – Not yet started</span>
        </div>
      </div>

      <!-- Recent Activity (incubator / grant applications) -->
      <div class="recent-activity">
        <strong>Recent Activity (June 2026):</strong> Incubation applications submitted to SINE‑IIT Bombay, FITT‑IIT Delhi, Venture Center, and iCreate. Applied to NIDHI‑PRAYAS prototyping grant. Awaiting response.
      </div>
      ...
      <div class="phase-block">
        <div class="phase-title">
          ...
          <span class="trl-badge trl-done" style="margin-left:auto;">100% COMPLETE</span>
        </div>
      ...
      <div class="phase-block">
        <div class="phase-title">
          ...
          <span class="trl-badge trl-planned" style="margin-left:auto;">NOT STARTED</span>
        </div>
        <ul class="checklist">
          <li class="planned">Incubation Support – Secure admission to a deep‑tech incubator (SINE, FITT, Venture Center, etc.).</li>
          <li class="planned">Grant Sourcing – Obtain milestone‑based government/institutional grants (NIDHI‑PRAYAS, BIRAC‑BIG, DRDO‑TDF).</li>
        ...
        <p style="margin-top:12px; font-size:0.85rem; color:#b8860b;">All activities pending successful incubation entry and funding. Applications submitted; awaiting response.</p>
      </div>
